/**
 * Forked from @deepseek-ai/dsh-client-ui-workspace/src/client/locales.ts (MIT, deepseek-ai/deepseek-harness). `sidebar.sessions` namespace dictionaries (registered by this package): the browsing region, tree rows, dialogs and pick/add flow. Fork adaptation: added the workspace folder menu key menu.copyPath.
 */
