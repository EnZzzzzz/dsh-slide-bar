/**
 * Forked from @deepseek-ai/dsh-client-ui-workspace/src/client/stores.ts (MIT, deepseek-ai/deepseek-harness). The workspace browser's viewing store: the session-list grouping mode, persisted across reloads. No fork adaptations beyond the file move.
 */
