/**
 * Forked from @deepseek-ai/dsh-client-ui-workspace/src/client/tree.ts (MIT, deepseek-ai/deepseek-harness). Derives the workspace browser tree from Host Workspace order and membership. Unassigned Sessions trail under Ungrouped; only the selected blank Session remains visible. No fork adaptations beyond the file move.
 */
import {
