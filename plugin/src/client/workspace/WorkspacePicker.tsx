/**
 * Forked from @deepseek-ai/dsh-client-ui-workspace/src/client/WorkspacePicker.tsx (MIT, deepseek-ai/deepseek-harness). Workspace pick/add flow. WorkspacePickFlow is the reusable core consumed directly by WorkspaceBrowser (same package). Retained only for that flow; the WorkspacePicker slot registration is not used by this package. No other fork adaptations.
 */
